...
from modeling_nezha import NeZhaForMaskedLM, NeZhaConfig
sys.path.append('/home/mw/project/code/utils')
from pre_tools import save_pickle, load_pickle, seed_everything
...
def main():
    ...
    data_path = '/home/mw/temp/tmp_data'
    ...
    parser.add_argument('--load_pretrain_model_path', type=str,
                        default='/home/mw/input/pretrain_model_5637')
