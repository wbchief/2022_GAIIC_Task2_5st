...
def predict_unlabeled_data(datalist, model_dirs, save_path):
    ...
    model_all.load_state_dict(
        torch.load('/home/mw/input/10fold_all_202205141290/model_all.pt',
                   map_location='cuda:0')
    )
...
if __name__ == '__main__':
    ...
    predict_unlabeled_data(
        datalist,
        model_dirs,
        f'/home/mw/work/old_unlabeled_pesudo_10-fold_best-model_30w-2.json'
    )
